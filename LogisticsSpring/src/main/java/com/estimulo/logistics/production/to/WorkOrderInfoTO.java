...
public class WorkOrderInfoTO {
	...
	public void setOperationCompleted(String string) {
		// TODO Auto-generated method stub
		
	}
	public String getSetOperationCompleted() {
		return setOperationCompleted;
	}
	public void setSetOperationCompleted(String setOperationCompleted) {
		this.setOperationCompleted = setOperationCompleted;
	}
