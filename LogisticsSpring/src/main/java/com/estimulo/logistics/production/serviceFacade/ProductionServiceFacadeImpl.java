...
public class ProductionServiceFacadeImpl implements ProductionServiceFacade {
	...
	public void setMpsApplicationService(MpsApplicationService mpsApplicationService) {
		this.mpsApplicationService = mpsApplicationService;
	}

	public void setMrpApplicationService(MrpApplicationService mrpApplicationService) {
		this.mrpApplicationService = mrpApplicationService;
	}

	public void setWorkOrderApplicationService(WorkOrderApplicationService workOrderApplicationService) {
