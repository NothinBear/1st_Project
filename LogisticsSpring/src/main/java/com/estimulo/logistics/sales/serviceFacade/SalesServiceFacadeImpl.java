...
public class SalesServiceFacadeImpl implements SalesServiceFacade {
	...
	public void setEstimateApplicationService(EstimateApplicationService estimateApplicationService) {
		this.estimateApplicationService = estimateApplicationService;
	}

	public void setContractApplicationService(ContractApplicationService contractApplicationService) {
		this.contractApplicationService = contractApplicationService;
	}

	public void setSalesPlanApplicationService(SalesPlanApplicationService salesPlanApplicationService) {
		this.salesPlanApplicationService = salesPlanApplicationService;
	}

	public void setDeliveryApplicationService(DeliveryApplicationService deliveryApplicationService) {
