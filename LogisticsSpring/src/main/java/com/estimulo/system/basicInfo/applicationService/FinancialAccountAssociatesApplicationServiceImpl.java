...
public class FinancialAccountAssociatesApplicationServiceImpl implements FinancialAccountAssociatesApplicationService {
	...
	public void setFinancialAccountAssociatesDAO(FinancialAccountAssociatesDAO financialAccountAssociatesDAO) {
		this.financialAccountAssociatesDAO = financialAccountAssociatesDAO;
	}
