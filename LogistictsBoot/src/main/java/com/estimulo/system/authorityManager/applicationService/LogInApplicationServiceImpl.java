...
import com.estimulo.system.authorityManager.mapper.MenuAuthorityDAO;
...
public class LogInApplicationServiceImpl implements LogInApplicationService {
	...
	public EmpInfoTO accessToAuthority(String companyCode, String workplaceCode, String inputId, String inputPassWord)
		...
		bean = checkEmpInfo(companyCode, workplaceCode, inputId); // 데이터 베이스 에서 우리가 로그인 화면에서 입력한 값을 보내줘서 비교한후 있으면 들고와서
																	// 그사람의 정보를 bean 에 담는다
	...
	private String[] getUserAuthorityGroupMenu(String empCode) {
		...
		ArrayList<AuthorityGroupMenuTO> authorityGroupMenuTOList = menuAuthorityDAO
				.selectUserMenuAuthorityList(empCode);
