...
import com.estimulo.system.base.applicationService.AddressApplicationServiceImpl;
import com.estimulo.system.base.applicationService.CodeApplicationService;
import com.estimulo.system.base.applicationService.CodeApplicationServiceImpl;
...
public class BaseServiceFacadeImpl implements BaseServiceFacade {
	...
	public ArrayList<CodeDetailTO> getDetailCodeList(String divisionCode) {
		...
		dataSourceTransactionManager.beginTransaction(false);//오토 커밋 false작업.. 에러 안나야 커밋하지
