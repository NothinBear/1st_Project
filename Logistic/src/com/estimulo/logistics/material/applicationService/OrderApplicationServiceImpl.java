...
import com.estimulo.logistics.material.dao.OrderDAOImpl;
...
public class OrderApplicationServiceImpl implements OrderApplicationService {
	...
	public HashMap<String,Object> checkOrderInfo(ArrayList<String> orderNoArr) {
		// TODO Auto-generated method stub
		if (logger.isDebugEnabled()) {
			logger.debug("OrderApplicationServiceImpl : checkOrderInfo 시작");
		}
		...
		if (logger.isDebugEnabled()) {
			logger.debug("OrderApplicationServiceImpl : checkOrderInfo 종료");
		}
		return resultMap;
	}
}
