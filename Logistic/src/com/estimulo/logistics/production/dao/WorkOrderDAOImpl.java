...
public class WorkOrderDAOImpl implements WorkOrderDAO {
   ...
   public HashMap<String,Object> getWorkOrderSimulationList(String mrpGatheringNoList , String mrpNoList) {
      ...
      try {
         ...
         cs.setString(1, mrpGatheringNoList);
         cs.setString(2, mrpNoList);
        ...
        //    bean.setMpsNo(rs.getString("MPS_NO"));
            ...
            String stockAfterWork=rs.getString("STOCK_AFTER_WORK");
            if(Integer.parseInt(stockAfterWork)<0) {
                bean.setStockAfterWork("재고부족");
            }else {
   ...
   public HashMap<String,Object> workOrder(String mrpGatheringNo, String workPlaceCode,String productionProcess,String mrpNo) {
      ...
      try {
         ...
         cs.setString(2, workPlaceCode);
         cs.setString(3, productionProcess);
         cs.setString(4, mrpNo);
         cs.registerOutParameter(5, OracleTypes.NUMBER);
         cs.registerOutParameter(6, OracleTypes.VARCHAR);
         cs.executeUpdate();
         
            int errorCode = cs.getInt(5);
            String errorMsg = cs.getString(6);
   ...
   public ArrayList<WorkOrderInfoTO> selectWorkOrderInfoList() {
       ...
       if (logger.isDebugEnabled()) { 
        ...
        query.append("SELECT * FROM WORK_ORDER_INFO WHERE OPERATION_COMPLETED IS NULL");
        ...
        bean.setOperationCompleted(rs.getString("OPERATION_COMPLETED"));
   ...
   public HashMap<String,Object> selectWorkSiteSituation(String workSiteCourse,String workOrderNo,String itemClassIfication) {
      ...
      if (logger.isDebugEnabled()) { 
        ...
        System.out.println(workSiteCourse);      // RawMaterials
        System.out.println(workOrderNo);         // WO20201029-356
        System.out.println(itemClassIfication);   // 반제품
        try { 
           
        conn = dataSourceTransactionManager.getConnection(); 
        
        StringBuffer query= new StringBuffer();
        System.out.println("프로시저 호출 :P_WORK_SITE_SITUATION");
   ...
   public void updateWorkCompletionStatus(String workOrderNo, String itemCode,String itemCodeList) {
      ...
      if (logger.isDebugEnabled()) { 
        ...
        StringBuffer query= new StringBuffer();
        System.out.println(workOrderNo);
        System.out.println("프로시저 호출@P_WORK_SITE_COMPLETION");
